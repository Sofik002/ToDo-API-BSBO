...
**API для управления задачами с системой приоритезации по матрице Эйзенхауэра и автоматическим контролем дедлайнов.**
...
## Запуск проекта
**Перед тем как запускать проект убедитесь, что сервер с базой данных запущен**
...
- **Статистика по дедлайнам:** - http://127.0.0.1:8000/api/v1/stats/deadlines
